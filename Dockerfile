...
RUN SECRET_KEY=dummy STATIC_URL=${STATIC_URL} AWS_STATIC_CUSTOM_DOMAIN=${AWS_STATIC_CUSTOM_DOMAIN} AWS_STORAGE_BUCKET_NAME=${AWS_STORAGE_BUCKET_NAME} python3 manage.py collectstatic --no-input
